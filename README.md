...
I have most experience with NetBeans, some with Eclipse and none with IntelliJ IDEA, and so far only NetBeans has been tested with the Maven format Phoenix. Thus, if someone comes along with a strong Eclipse or IntelliJ IDEA background, and would like to stay exclusively with them, the Phoenix project currently does not provide much out of the box support beyond being Maven format. But then again with my short experience in doing larger than small real world projects, I would not expect to be able to advice veteran developers. 
