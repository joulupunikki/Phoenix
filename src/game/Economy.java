...
//        testPrintResTypeTable();
     ...
     * 
     * NOTE: Units eat a maximum of 1 food (if type_data.eat > 0). Cities all eat 10 food.
     * 
     */   
...
//                            System.out.println("B Deficit = "+deficit+", Health = "+city.health+", Loss = "+ health_loss);
    ...
    /**
     * Calculate how many resources a city produces per turn (modified for loyalty, traits, etc).
     * Is not affected by whether secondary city has enough inputs (on a particular turn).
     * 
